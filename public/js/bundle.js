...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFkZXgiLCJhIjoiY2thZzZlZmtnMDNsZTJzcWJncG1pa3ltaSJ9.Wp0A7XGxkP2vPIhsRr5sNw';
...
console.log('hello from the client side'); //DOM ELEMENTS
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirmed = document.getElementById('password-confirmed').value;
            _context.next = 7;
