...
//virtual populate for populating the the schema with reviews from parent referencing since the number of reviews is not fixed and it grows
tourSchema.virtual('reviews', {
  ref: 'Review',
  foreignField: 'tour',
  localField: '_id'
});
//DOCUMENT MIDDLEWARE : runs before .save() and .create() and doesnt work for .insertMany()
